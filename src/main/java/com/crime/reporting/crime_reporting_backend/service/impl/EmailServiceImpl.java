...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmail(String to, String subject, String text) {
        try {
            ...
            helper.setFrom(emailFrom, "Police & Crime Management System");
    ...
    public void sendPasswordResetCode(String to, String code) {
        String subject = "Police & Crime Management System - Password Reset Code";
        String message = "Hello,\n\n" +
                "You've requested to reset your password for your Police & Crime Management System account.\n\n" +
